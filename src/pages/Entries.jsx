...
const Entries = () => {
    ...
    const handleAssign = useCallback(async () => {
        ...
        try {
            const res = await axios.put("http://localhost:8800/assign", {
                assignedId: userID,
            ...
            const updatedEntries = await axios.get("http://localhost:8800/entries");
    ...
    const handleStatusChange = useCallback(async (entryId, newStatus) => {
        try {
            await axios.put(`http://localhost:8800/update-status/${entryId}`, { 
                status: newStatus 
            });
    ...
    const handleUnassign = useCallback(async () => {
        ...
        try {
            const res = await axios.put("http://localhost:8800/unassign", {
                selectedEntryIds: Array.from(selectedEntries)
            });
            alert(res.data);
